  ...
  return (
    <motion.div initial="hidden" animate="visible" className='flex flex-row items-center justify-center px-20 mt-40 w-full z-[20]'>
       ...
       <motion.div variants={slideInFromTop} className="Welcome-box py-[8px] px-[8px] border border-[#7042f88b] opacity-[0.9]">
        ...
        <h1 className='welcome-text text-[13px] text-neutral-400'>Fullstack Developer Portfolio</h1>
    </motion.div>
    ...
    <motion.div variants={slideInFromRight(0.8)} className='w-full h-full flex justify-center item-center'>
        <Image src="/mainIconsdark.svg" alt="work icons" height={650} width={650}></Image>
